...
Plans:
- [x] 09-01-PLAN.md — Expand PATCH API for full automation config + AutomationConfigForm controlled component with Save/Cancel and success toast
- [x] 09-02-PLAN.md — Add custom content props to email templates, live email preview panel, AutomationDetailClient wrapper sharing state between form and preview
- [x] 09-03-PLAN.md — Wire customized action_config into executeEmailAction, Inngest callers, and test-send path
...
Plans:
- [x] 10-01-PLAN.md — Wire SendTestEmailButton into AutomationDetailClient with live form values, forward current content overrides to send-test API
...
Plans:
- [x] 11-01-PLAN.md — Dashboard and customer list polish: install Skeleton, loading.tsx for dashboard + customers, dashboard zero-customer empty state, customer empty state guidance
- [x] 11-02-PLAN.md — Automation pages polish: loading.tsx for automations list + automations detail, skeleton mirrors 7-column table and two-card detail layout
