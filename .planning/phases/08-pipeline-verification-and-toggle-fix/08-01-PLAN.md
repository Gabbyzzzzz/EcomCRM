...
must_haves:
  truths:
    ...
    - "The days_since_order email action executes correctly for eligible customers (the cron wiring is confirmed by audit in Task 1, and the test-trigger endpoint exercises the action execution path directly)"
